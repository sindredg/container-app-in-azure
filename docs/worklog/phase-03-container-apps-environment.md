...
The 409 Conflict was `MissingSubscriptionRegistration` for namespace `Microsoft.App`, pointing at `main.tf` line 29.
...
The namespace reached `Registered`, which unblocked the second apply.
...
The environment exists inside `rg-container-scale-lab-dev` and exposes the Azure-generated domain `graysand-e63d8c5e.norwayeast.azurecontainerapps.io`.
